    ...
    <div class="panel">
        ...
        <!-- <transition name="slide-fade">
            <div class="page" v-if="currentStep === 3">
                ...
                <el-select v-model="character.ExtraversionIndex" value-key="" placeholder="内向/外向和社交行为" filterable>
                    <el-option v-for="item in characterDescOptions.ExtraversionIndex" :key="item" :label="item"
                        :value="item">
                    </el-option>
                </el-select>
                <div class="text-s">
                ...
                <el-select v-model="character.AgreeablenessIndex" value-key="" placeholder="合作和富有同情心的倾向" filterable>
                    <el-option v-for="item in characterDescOptions.AgreeablenessIndex" :key="item" :label="item"
                        :value="item">
                    </el-option>
                </el-select>
                <div class="text-s">
                ...
                <el-select v-model="character.OpennessIndex" value-key="" placeholder="是否愿意接受新经验和方法" filterable>
                    <el-option v-for="item in characterDescOptions.OpennessIndex" :key="item" :label="item"
                        :value="item">
                    </el-option>
                </el-select>
                <div class="text-s">
                ...
                <el-select v-model="character.ConscientiousnessIndex" value-key="" placeholder="是否有组织性和责任感的倾向"
                    filterable>
                    <el-option v-for="item in characterDescOptions.ConscientiousnessIndex" :key="item" :label="item"
                        :value="item">
                    </el-option>
                </el-select>
                <div class="text-s">
                ...
                <el-select v-model="character.NeuroticismIndex" value-key="" placeholder="是否容易情绪不稳定和负面情绪" filterable>
                    <el-option v-for="item in characterDescOptions.NeuroticismIndex" :key="item" :label="item"
                        :value="item">
                    </el-option>
                </el-select>
...
const characterDescOptions = {
    ExtraversionIndex: ['非常内向', '有点内向', '不明显', '有点外向', '非常外向'],
    AgreeablenessIndex: ['非常不友好', '有点不友好', '不明显', '有点友好', '非常友好'],
    OpennessIndex: ['非常保守', '有点保守', '不明显', '有点开放', '非常开放'],
    ConscientiousnessIndex: ['非常不负责', '有点不负责', '不明显', '有点负责', '非常负责'],
    NeuroticismIndex: ['非常稳定', '有点稳定', '不明显', '有点神经质', '非常神经质'],
}
...
const character: any = ref({
    ...
    // ExtraversionIndex: '非常内向',// 外向性：外向和社交行为
    // AgreeablenessIndex: '不友好',//宜人：合作和富有同情心的倾向
    // OpennessIndex: '不明显',//开放性：接受新经验和方法
    // ConscientiousnessIndex: '不负责',// 责任心：有组织性和责任感的倾向
    // NeuroticismIndex: '非常神经质',//神经质：容易情绪不稳定和负面情绪
