class CustomServiceButton{static instance=null;constructor(t){if(CustomServiceButton.instance)return CustomServiceButton.instance;(CustomServiceButton.instance=this).accessKey=t,this.iframe=null,this.iframeDisplay=!1,this.accessKey&&this.render()}render(){var t=document.createElement("div");t.classList.add("aics-custom-service-btn"),t.style.position="fixed",t.style.bottom="40px",t.style.right="40px",t.style.backgroundColor="#fff",t.style.border="1px solid #ccc",t.style.borderRadius="50%",t.style.width="60px",t.style.height="60px",t.style.cursor="pointer",t.style.zIndex="99999";t.innerHTML=`
<svg t="1712896672087" style="margin:5px" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="1512" width="48" height="48">
...
</path></svg>`,t.addEventListener("click",this.toggleChat.bind(this)),document.body.appendChild(t)}toggleChat(){this.iframe?"none"===this.iframe.style.display?this.iframe.style.display="block":this.iframe.style.display="none":this.createChat()}createChat(){var t,e;this.iframe||(t=document.createElement("iframe"),e="http://leapcapital.cn:800/aics/#/?accessKey="+this.accessKey,t.src=e,t.style.position="fixed",t.style.bottom="120px",t.style.right="20px",t.style.width="300px",t.style.height="500px",t.style.border="none",t.style.zIndex="9999",t.style.backgroundColor="white",t.style.display="block",this.iframe=t,document.body.appendChild(t))}}