class CustomServiceButton{static instance=null;constructor(e){if(CustomServiceButton.instance)return CustomServiceButton.instance;(CustomServiceButton.instance=this).accessKey=e,this.iframe=null,this.iframeDisplay=!1,this.accessKey&&this.render()}render(){var t,s,i,n,l,e=document.createElement("div");e.classList.add("aics-custom-service-btn"),e.style.position="fixed",e.style.bottom="40px",e.style.right="40px",e.style.backgroundColor="#fff",e.style.border="1px solid #ccc",e.style.borderRadius="50%",e.style.width="40px",e.style.height="40px",e.style.cursor="pointer",e.style.zIndex="99999";function o(e){(e=e||window.event).preventDefault(),n=e.clientX,l=e.clientY,document.onmouseup=a,document.onmousemove=c}function c(e){(e=e||window.event).preventDefault(),s=n-e.clientX,i=l-e.clientY,n=e.clientX,l=e.clientY,t.style.top=t.offsetTop-i+"px",t.style.left=t.offsetLeft-s+"px"}function a(){document.onmouseup=null,document.onmousemove=null}e.innerHTML=`
<svg t="1712896672087" style="margin:5px" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="1512" width="32" height="32">
...
`,e.addEventListener("click",this.toggleChat.bind(this)),t=e,l=n=i=s=0,document.getElementById(t.id+"header")?document.getElementById(t.id+"header").onmousedown=o:t.onmousedown=o,document.body.appendChild(e)}toggleChat(){this.iframe?"none"===this.iframe.style.display?this.iframe.style.display="block":this.iframe.style.display="none":this.createChat()}createChat(){var e,t;this.iframe||(e=document.createElement("iframe"),t="http://leapcapital.cn:800/aics/#/?accessKey="+this.accessKey,e.src=t,e.style.position="fixed",e.style.bottom="120px",e.style.right="20px",e.style.width="300px",e.style.height="500px",e.style.border="none",e.style.zIndex="9999",e.style.backgroundColor="white",e.style.display="block",this.iframe=e,document.body.appendChild(e))}}