<template>
  <div class="panel">
    ...
    <div class="things">
      ...
      <el-input class="w-4/5 mt-8" v-model="fortunes" :placeholder="t['ph_fortunes']" size="large" clearable></el-input>
      <el-input class="w-4/5 mt-8" type="textarea" size="large" :rows="4" v-model="poems" :placeholder="t['ph_poems']"
        clearable :autosize="{ minRows: 4, maxRows: 8 }">
      </el-input>

      <el-button class="w-4/5 mt-8 btn" type="primary" size="large" @click="submit"> {{ t['submit'] }} </el-button>
    </div>
  </div>
